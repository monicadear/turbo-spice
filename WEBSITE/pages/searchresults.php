...
$sql = "select id, title, titleshow, category, text from pagecontent where text LIKE '%$pattern%'";
...
echo "$b. <a href=/pages/main.php?pageid=$id&pagecategory=$category&keywords=$pattern>$titleshow</a><BR>\n";

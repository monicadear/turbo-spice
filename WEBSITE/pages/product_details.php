...
echo "<div id=storeshowpicturedetail>\n";

	if (isset($filename) && $filename !=="")
	{echo "<a href=product_details_large.php?productid=$id><img src=/productsmall/$filename border=0 width=250 alt='product'></a><BR>\n";
	}
	...
	{echo "<a href=product_details_large.php?productid=$id><img src=/productsmall/$filename2 border=0 width=125 alt='product'></a><BR>\n";}

	else {echo "";}

	echo "<a href=product_details_large.php?productid=$id><img src=/images/icons/grow.jpg border=0 alt=view width=20 align=right hspace=5></a><BR>\n";
...
echo "<a href=http://translate.google.com/translate?u=http://www.growyouroakland.org/pages/product_details.php?productid=$id&amp;langpair=en%7Ces&amp;hl=es&amp;ie=UTF-8&amp;ie=UTF-8&amp;oe=UTF-8&amp;prev=%2Flanguage_tools class=translation>en Espa&ntilde;ol</a> ";

echo "<a href=http://translate.google.com/translate?u=http://www.growyouroakland.org/pages/product_details.php?productid=$id&amp;langpair=en%7Czh&amp;hl=zh&amp;ie=UTF-8&amp;ie=UTF-8&amp;oe=UTF-8&amp;prev=%2Flanguage_tools><img src=/images/chinesetranslation.jpg border=0 alt=Chinese valign=middle></a>";

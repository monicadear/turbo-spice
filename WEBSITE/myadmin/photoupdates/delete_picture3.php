...
<? echo "<form method='post' action='delete_picture3_handler.php'>"; ?> 
...
echo "<tr><th>Picture, if any:</th><td><img src=/photogallery/$picture3 width=150 border=1></td></tr>";
...
echo "<input type=hidden name='picture3' value='$picture3'>";

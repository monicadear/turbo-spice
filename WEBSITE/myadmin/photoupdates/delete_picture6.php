...
<? echo "<form method='post' action='delete_picture6_handler.php'>"; ?> 
...
echo "<tr><th>Picture, if any:</th><td><img src=/photogallery/$picture6 width=150 border=1></td></tr>";
...
echo "<input type=hidden name='picture6' value='$picture6'>";

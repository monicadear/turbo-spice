...
$pid=$_POST['pid'];
$picture3description=$_POST['picturedescription'];
$picture3description = htmlspecialchars("$picture3description", ENT_QUOTES);
$picture3description = ereg_replace("\r\n\r\n", "&lt;BR&gt;&lt;BR&gt;\n", $picture3description);
$picture3description = ereg_replace("\r\n", "&lt;BR&gt;\n", $picture3description);
...
$sql = "update $tablebase set date='$date', picture3description='$picture3description'

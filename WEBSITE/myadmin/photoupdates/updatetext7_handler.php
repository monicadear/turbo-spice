...
$pid=$_POST['pid'];
$picture7description=$_POST['picturedescription'];
$picture7description = htmlspecialchars("$picture7description", ENT_QUOTES);
$picture7description = ereg_replace("\r\n\r\n", "&lt;BR&gt;&lt;BR&gt;\n", $picture7description);
$picture7description = ereg_replace("\r\n", "&lt;BR&gt;\n", $picture7description);
...
$sql = "update $tablebase set date='$date', picture7description='$picture7description'

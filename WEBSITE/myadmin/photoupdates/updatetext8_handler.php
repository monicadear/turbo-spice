...
$pid=$_POST['pid'];
$picture8description=$_POST['picturedescription'];
$picture8description = htmlspecialchars("$picture8description", ENT_QUOTES);
$picture8description = ereg_replace("\r\n\r\n", "&lt;BR&gt;&lt;BR&gt;\n", $picture8description);
$picture8description = ereg_replace("\r\n", "&lt;BR&gt;\n", $picture8description);
...
$sql = "update $tablebase set date='$date', picture8description='$picture8description'

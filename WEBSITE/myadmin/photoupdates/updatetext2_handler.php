...
$pid=$_POST['pid'];
$picture2description=$_POST['picturedescription'];
$picture2description = htmlspecialchars("$picture2description", ENT_QUOTES);
$picture2description = ereg_replace("\r\n\r\n", "&lt;BR&gt;&lt;BR&gt;\n", $picture2description);
$picture2description = ereg_replace("\r\n", "&lt;BR&gt;\n", $picture2description);
...
$sql = "update $tablebase set date='$date', picture2description='$picture2description'

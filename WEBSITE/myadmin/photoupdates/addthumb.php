...
echo "<form enctype='multipart/form-data' method='post'  action='addthumb_handler.php'>";
echo "File Upload:<BR>\n";
...
else if (isset($thumbnailpass)) {
   echo "Current photo:<BR>";
   echo "<img src=/thumbs/$thumbnailpass width=150 border=1><BR><BR>\n";

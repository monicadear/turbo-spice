...
<? echo "<form method='post' action='delete_picture4_handler.php'>"; ?> 
...
echo "<tr><th>Picture, if any:</th><td><img src=/photogallery/$picture4 width=150 border=1></td></tr>";
...
echo "<input type=hidden name='picture4' value='$picture4'>";

...
<? echo "<form method='post' action='delete_picture7_handler.php'>"; ?> 
...
echo "<tr><th>Picture, if any:</th><td><img src=/photogallery/$picture7 width=150 border=1></td></tr>";
...
echo "<input type=hidden name='picture7' value='$picture7'>";

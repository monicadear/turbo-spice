...
$pid=$_POST['pid'];
$picture6description=$_POST['picturedescription'];
$picture6description = htmlspecialchars("$picture6description", ENT_QUOTES);
$picture6description = ereg_replace("\r\n\r\n", "&lt;BR&gt;&lt;BR&gt;\n", $picture6description);
$picture6description = ereg_replace("\r\n", "&lt;BR&gt;\n", $picture6description);
...
$sql = "update $tablebase set date='$date', picture6description='$picture6description'

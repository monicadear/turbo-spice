...
<? echo "<form method='post' action='delete_picture8_handler.php'>"; ?> 
...
echo "<tr><th>Picture, if any:</th><td><img src=/photogallery/$picture8 width=150 border=1></td></tr>";
...
echo "<input type=hidden name='picture8' value='$picture8'>";

...
<? echo "<form method='post' action='delete_picture5_handler.php'>"; ?> 
...
echo "<tr><th>Picture, if any:</th><td><img src=/photogallery/$picture5 width=150 border=1></td></tr>";
...
echo "<input type=hidden name='picture5' value='$picture5'>";

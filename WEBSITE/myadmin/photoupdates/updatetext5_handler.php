...
$pid=$_POST['pid'];
$picture5description=$_POST['picturedescription'];
$picture5description = htmlspecialchars("$picture5description", ENT_QUOTES);
$picture5description = ereg_replace("\r\n\r\n", "&lt;BR&gt;&lt;BR&gt;\n", $picture5description);
$picture5description = ereg_replace("\r\n", "&lt;BR&gt;\n", $picture5description);
...
$sql = "update $tablebase set date='$date', picture5description='$picture5description'

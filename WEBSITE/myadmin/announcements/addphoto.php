...
echo "<form enctype='multipart/form-data' method='post'  action='addphoto_handler.php'>";
echo "File Upload:<BR>\n";
...
echo "<input type='submit' name='enter' value='submit'></form>";
   ...
   echo "<img src=/announcementimages/$picturepass width=150 border=1><BR><BR>\n";

...
Type the two words, then click "submit" to send your message.<BR><BR><?require_once('../library/recaptchalib.php');$publickey = "6Le0aAYAAAAAAEijIfzg0Zc0cZlY995MOCq7scHa"; // you got this from the signup page$privatekey = "6Le0aAYAAAAAANyuCEqt6INAG7Y3wcVZPfJ7voHK"; // you got this from the signup page# the response from reCAPTCHA$resp = null;# the error code from reCAPTCHA, if any$error = null;

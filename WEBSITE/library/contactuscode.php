...
<table border=0>
<tr><th><b>First Name</b> <span class=red>*</span>:</th><td><input type=text name=firstname value="<?echo "$firstname";?>"></td></tr>
<tr><th><b>Last Name</b> <span class=red>*</span>:</th><td><input type=text name=lastname value="<?echo "$lastname";?>"></td></tr>
<tr><th><b>E-mail</b> <span class=red>*</span>:</th><td><input type=text name=myemail value="<?echo"$myemail";?>"></td></tr>
<tr><th><b>Phone</b> <span class=red>*</span>:</th><td><input type=text name=myphone value="<?echo"$myphone";?>"></td></tr>
